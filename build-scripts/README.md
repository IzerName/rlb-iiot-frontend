# Bundling Reallab IIOT Frontend

The Reallab IIOT build pipeline contains various steps to prepare a build.
...
Currently in Reallab IIOT we use a bundler to convert TypeScript, CSS and JSON files to JavaScript files that the browser understands.
