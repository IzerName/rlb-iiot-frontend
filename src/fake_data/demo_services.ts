...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the Reallab IIOT service.", fields: {} },
    restart: { description: "Restart the Reallab IIOT service.", fields: {} },
    check_config: {
      description:
        "Check the Reallab IIOT configuration files for errors. Errors will be displayed in the Reallab IIOT log.",
      fields: {},
    },
    update_entity: {
