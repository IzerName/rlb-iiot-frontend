        ...
        if (this.hass!.config.state === STATE_NOT_RUNNING) {
          showToast(this, {
            message:
              ...
              "Reallab IIOT is starting. Not everything will be available until it is finished.",
            duration: -1,
            dismissable: false,
            action: {
              text:
          ...
          ({ showAlertDialog }) => {
            showAlertDialog(this, {
              ...
              text:
                ...
                "Reallab IIOT is running in safe mode, custom integrations and modules are not available. Restart Reallab IIOT to exit safe mode.",
            });
          }
        );
      }
